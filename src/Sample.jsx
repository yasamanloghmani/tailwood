    ...
    return(
        <div>
            ...
            <div className="grid grid-cols-3 p-16 gap-8">
                <Services hclass="mb-8 font-bold text-3xl mb-2 text-center text-purples-med" pclass="font-medium text-xl mb-2  text-blue-dark text-base" btnclass="bg-purples-light hover:bg-purples-dark text-falling-gray font-bold py-4 p-6 border border-falling-gray rounded my-8" h="SEO SERVICES" p='Our SEO experts will develop sustainable strategies to bring in more phone calls, boost sales and increase brand visibility:'/>
                <Services hclass="mb-8 font-bold text-3xl mb-2 text-center text-purples-med" pclass="font-medium text-xl mb-2  text-blue-dark text-base" btnclass="bg-purples-light hover:bg-purples-dark text-falling-gray font-bold py-4 p-6 border border-falling-gray rounded my-8" h="PPC SERVICES" p='Our digital marketing team includes PPC experts who bring ready-to-buy traffic to your site using targeted ads.'/>
                <Services  hclass="mb-8 font-bold text-3xl mb-2 text-center text-purples-med"pclass="font-medium text-xl mb-2  text-blue-dark text-base" btnclass="bg-purples-light hover:bg-purples-dark text-falling-gray font-bold py-4 p-6 border border-falling-gray rounded my-8" h="SOCIAL MEDIA" p="Whether it’s Facebook, Instagram, LinkedIn or all of the above, we have your advertising and social media management covered."/>
            </div>
            <List />
