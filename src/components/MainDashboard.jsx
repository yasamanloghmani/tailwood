    ...
    render(){
        return(
            <div className='w-5/6 float-right'>
                ...
                <Team teamimg={teamimg} p="Mission-driven full stack developer with a passion for thoughtful UI design. I have more than 5 years of experience in web design and development. My background in Information Technology has allowed me to have a better understanding in computer science and technology." h="Yasaman Loghmani"/>
